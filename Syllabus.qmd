...
- **Slides**: [Introduction_to_Linear_Regression.qmd](lectures/Introduction_to_Linear_Regression.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/Introduction_to_Linear_Regression.html)
...
- **Slides**:
  - [ols_estimator.qmd](lectures/ols_estimator.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/ols_estimator.html)
  - [OLS_Derivation.qmd](lectures/OLS_Derivation.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/OLS_Derivation.html)
  - [gauss_markov_slides.qmd](lectures/gauss_markov_slides.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/gauss_markov_slides.html)
...
- **Slides**: [linear_regression_matrix_algebra.qmd](lectures/linear_regression_matrix_algebra.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/linear_regression_matrix_algebra.html)
...
- **Slides**:
  - [multiple_regression.qmd](lectures/multiple_regression.qmd) | [View Online](https://crweber9874.github.io/linear_regression_class/lectures/multiple_regression.html)
  - [dummy_variables_model_fit.qmd](lectures/dummy_variables_model_fit.qmd)

### Week 7 (3/3): Midterm Exam

---

### Week 8 (3/17): Interactions and Heteroskedasticity

- **Topics**: Categorical and Continuous Interactions, Non-Additivity, Heteroskedasticity Detection and Correction, Weighted Least Squares, Robust Standard Errors
- **Reading**: Fox, Chapter 12; Course Notes, Chapters 6–7
- **Slides**: [interactions_heteroskedasticity.qmd](lectures/interactions_heteroskedasticity.qmd)

### Week 9 (3/24): Collinearity

- **Topics**: Multicollinearity detection and solutions
- **Reading**: Fox, Chapter 13; Course Notes, Chapter 8
- **Slides**: [multicollinearity.qmd](lectures/multicollinearity.qmd)
